...
-- create table ray_hist_bond_warrantor as select * from hist_bond_warrantor;
...
where lower(table_schema) = lower('public')
  ...
  lower('ray_stg_compy_bondissuer'),
  lower('ray_hist_compy_bondissuer')
);
-- 期望值： 2
...
-- drop table hist_bond_warrantor;
