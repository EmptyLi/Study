...
select setval('seq_rating_hist_factor_score',case when max(rating_factor_id :: bigint) > nextval('seq_rating_hist_factor_score')
  then max(rating_factor_id :: bigint)
       else nextval('seq_rating_hist_factor_score') end)
