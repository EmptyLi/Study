-- select * from compy_finance where company_id = 80095 and rpt_dt = '2017-12-31'::date;
-- select * from compy_finance_last_y where company_id = 1519;
-- select * from compy_finance_bf_last_y where company_id = 1519;
-- select * from compy_factor_finance where company_id = 1519;
-- select * from compy_factor_operation_expert where company_id = 1519 and rpt_dt = date'2017-12-31';
-- select * from compy_factor_finance_expert where company_id = 1519;

-- 是否需要重新计算指标
set time zone 'PRC';
select * from compy_basicinfo where company_nm = '中国石油化工股份有限公司';
-- 1519
...
-- 经营数据
delete from compy_factor_operation_expert where company_id = 1519 and rpt_dt = date'2017-12-31';
...
commit;
-- insert into compy_factor_finance_expert
--   select
--     compy_factor_finance_sid + 10000000000000 as compy_factor_finance_sid,
--     company_id,
--     exposure_sid,
--     factor_cd,
--     factor_value,
...
--     isdel,
--     now()                                     as updt_dt
--   from compy_factor_finance_expert
--   where company_id = 1519 and rpt_dt = date '2016-12-31';
