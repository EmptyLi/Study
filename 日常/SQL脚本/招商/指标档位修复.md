```sql
CREATE TABLE TEMP_MODIFY_DEFINE_BAK
(
  EXPOSURE_SID VARCHAR2(1000),
  MODIFY_CLASS VARCHAR2(1000),
  MODIFY_ITEM  VARCHAR2(1000),
  MODITY_VALUE VARCHAR2(3000),
  MODIFY_TYPE  VARCHAR2(100),
  FLAG         VARCHAR2(10),
  CNT          VARCHAR2(10),
  UPDT_DT      VARCHAR2(100)
)
```
